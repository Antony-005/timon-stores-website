      ...
      <section className="bg-sand py-16 px-6">
        <div className="max-w-6xl mx-auto grid gap-8 md:grid-cols-2">
          ...
          <div>
            ...
            <p>To deliver quality products through reliable distribution while creating lasting value for customers, partners and communities.</p>
          </div>
        </div>
      </section>
